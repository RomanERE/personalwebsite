# 📟 RPI-NODE: Personal CV & Monitoring Dashboard
...
* **📊 Live Hardware Telemetry:** Моніторинг завантаження ОЗП, температури процесора, кількості унікальних IP та активних з'єднань через PHP-бекенд.
